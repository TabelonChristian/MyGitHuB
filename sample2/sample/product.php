            ...
            echo "<tr>
                    ...
                    <td>
                        <form action='edit_product.php' method='post'>
                            <input type='hidden' name='edit_product_id' value='{$row['s_id']}'>
...
<div class="button-container">
    ...
    <a href="index.php" class="add-button">Patient Data</a>
    <a href="transaction.php" class="add-button">Transaction</a>
</div>
